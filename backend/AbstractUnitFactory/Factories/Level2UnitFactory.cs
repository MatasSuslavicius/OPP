...
namespace tower_battle.AbstractUnitFactory.Factories
{
    public class Level2UnitFactory : AbstractUnitFactory
    {
        ...
        {
            Unit unit = new Level2NormalMelee { Position = SpawnPosition };
        ...
        {
            Unit unit = new Level2FastMelee { Position = SpawnPosition  };
        ...
        {
            Unit unit = new Level2SlowMelee { Position = SpawnPosition  };
