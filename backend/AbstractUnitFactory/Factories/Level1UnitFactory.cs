...
namespace tower_battle.AbstractUnitFactory.Factories
{
    public class Level1UnitFactory : AbstractUnitFactory
    {
        ...
        {
            Unit unit = new Level1NormalMelee {Position = SpawnPosition};
        ...
        {
            Unit unit = new Level1FastMelee  {Position = SpawnPosition};
        ...
        {
            Unit unit = new Level1SlowMelee {Position = SpawnPosition};
