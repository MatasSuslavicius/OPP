...
namespace tower_battle.AbstractUnitFactory.Builder
{
    public class Director
    {
        ...
        {
            return builder.AddMovement(strategy).AddDamage(2).AddHealth(100).AddKillReward(50).Build();
        }
        public Unit ConstructLevel2(IBuilder builder, MoveStrategy strategy)
        {
            return builder.AddMovement(strategy).AddDamage(4).AddHealth(200).AddKillReward(100).Build();
        }
    }
}
